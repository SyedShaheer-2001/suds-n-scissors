...
const LoaderComlink = lazy(() => import("./LoaderComlink.js")), VisualEditing = (props) => {
  ...
  let t12;
  $[20] !== comlink2 || $[21] !== comlinkStatus || $[22] !== components || $[23] !== inFrame || $[24] !== inPopUp || $[25] !== onPerspectiveChange || $[26] !== plugins || $[27] !== zIndex ? (t12 = inFrame !== null && inPopUp !== null && /* @__PURE__ */ jsx(Overlays, { comlink: comlink2, comlinkStatus, componentResolver: components, onPerspectiveChange, plugins, inFrame, inPopUp, zIndex }), $[20] = comlink2, $[21] = comlinkStatus, $[22] = components, $[23] = inFrame, $[24] = inPopUp, $[25] = onPerspectiveChange, $[26] = plugins, $[27] = zIndex, $[28] = t12) : t12 = $[28];
  let t13;
  $[29] !== comlink2 || $[30] !== history || $[31] !== refresh ? (t13 = comlink2 && /* @__PURE__ */ jsxs(Fragment, { children: [
  ...
  ] }), $[29] = comlink2, $[30] = history, $[31] = refresh, $[32] = t13) : t13 = $[32];
  let t14;
  $[33] !== comlinkStatus || $[34] !== hasQueryListeners2 ? (t14 = comlinkStatus === "connected" && hasQueryListeners2 && /* @__PURE__ */ jsx(Suspense, { children: /* @__PURE__ */ jsx(LoaderComlink, {}) }), $[33] = comlinkStatus, $[34] = hasQueryListeners2, $[35] = t14) : t14 = $[35];
  let t15;
  $[36] !== t12 || $[37] !== t13 || $[38] !== t14 ? (t15 = /* @__PURE__ */ jsxs(Fragment, { children: [
    t12,
    t13,
    t14
  ] }), $[36] = t12, $[37] = t13, $[38] = t14, $[39] = t15) : t15 = $[39];
  const children = t15;
  if (portal === !1 || !portalElement)
    return children;
  let t16;
  return $[40] !== children || $[41] !== portalElement ? (t16 = createPortal(children, portalElement), $[40] = children, $[41] = portalElement, $[42] = t16) : t16 = $[42], t16;
};
