...
import { c as createComponent } from './astro-component_XvzwQ1bR.mjs';
import 'piccolore';
import { q as createRenderInstruction, k as renderTemplate, v as renderSlot, o as renderHead, h as addAttribute, m as maybeRenderHead, p as renderComponent } from './entrypoint_Bkqw8PhP.mjs';
import 'clsx';
...
</p> <div class="price-list" aria-label="À la carte service pricing"> <!-- Row 1 --> <div class="price-row"> <span class="price-name">Ear Cleaning</span> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$10 – $15</span> </div> <!-- Row 2 --> <div class="price-row"> <div class="price-name-wrap"> <span class="price-name">Ear Plucking</span> <span class="price-desc">add-on to cleaning</span> </div> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$10 – $15</span> </div> <!-- Row 3 --> <div class="price-row"> <span class="price-name">Nail Cutting &amp; Dremel</span> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$15 – $25</span> </div> <!-- Row 4 --> <div class="price-row"> <span class="price-name">Nail Cutting &amp; Paw Pad Shave</span> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$25 – $35</span> </div> <!-- Row 5 --> <div class="price-row"> <span class="price-name">Sanitary Area Shave</span> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$15</span> </div> <!-- Row 6 --> <div class="price-row"> <span class="price-name">Anal Gland Expression</span> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$10 – $15</span> </div> <!-- Row 7 --> <div class="price-row"> <span class="price-name">Bang Trim</span> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$5+</span> </div> <!-- Row 8 --> <div class="price-row"> <span class="price-name">Face Trim</span> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$15+</span> </div> <!-- Row 9 --> <div class="price-row"> <span class="price-name">Handstripping</span> <span class="price-leader" aria-hidden="true"></span> <span class="price-value">$40 / 30 min</span> </div> </div> <div class="walkin-badge"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="14" height="14" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
