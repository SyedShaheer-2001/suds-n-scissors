...
import { c as createComponent } from './astro-component_CAVT7PaB.mjs';
import 'piccolore';
import { q as createRenderInstruction, k as renderTemplate, v as renderSlot, o as renderHead, h as addAttribute, m as maybeRenderHead, p as renderComponent } from './entrypoint_BnPmqvJz.mjs';
import 'clsx';
...
Welcome to Suds 'n' Scissors. Our professionally trained groomers
            ...
            session.
</p> <div class="about-callout reveal reveal-delay-3" id="accepting-badge"> <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"></path></svg>
Now accepting new clients of all sizes
</div> <a href="#contact" class="about-cta reveal reveal-delay-4" id="about-contact-link">
Book with us today
<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" width="14" height="14" aria-hidden="true"><path stroke-linecap="round" stroke-linejoin="round" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg> </a> </div> <div class="about-aside"> <div class="about-stat reveal"> <div class="about-stat-number">8+</div> <div class="about-stat-label">Years serving Coquitlam</div> </div> <div class="about-stat reveal reveal-delay-1"> <div class="about-stat-number">4</div> <div class="about-stat-label">Expert groomers on staff</div> </div> <div class="about-stat reveal reveal-delay-2"> <div class="about-stat-number">★★★</div> <div class="about-stat-label">ThreeBest Rated 2025</div> </div> </div> </div> </section> <!-- ══════════════════════════════
         SERVICES
...
</p> </div> </article> <!-- Mana --> <article class="team-card" role="listitem" id="team-mana"> <img class="team-card-img" src="/images/service_bath_tidy.png" alt="Mana, groomer at Suds 'n' Scissors" width="400" height="300" loading="lazy"> <div class="team-card-body"> <h3 class="team-card-name">Mana</h3> <p class="team-card-bio">
...
</p> </div> </article> <!-- Rachel --> <article class="team-card" role="listitem" id="team-rachel"> <img class="team-card-img" src="/images/service_bath_brush.png" alt="Rachel, groomer at Suds 'n' Scissors" width="400" height="300" loading="lazy"> <div class="team-card-body"> <h3 class="team-card-name">Rachel</h3> <p class="team-card-bio">
With over 10 years of grooming experience, Rachel trained at
                ...
                grooms.
</p> </div> </article> <!-- Nari --> <article class="team-card" role="listitem" id="team-nari"> <img class="team-card-img" src="/images/service_full_grooming.png" alt="Nari Lee, Asian Style Pet Stylist at Suds 'n' Scissors" width="400" height="300" loading="lazy"> <div class="team-card-body"> <h3 class="team-card-name">Nari Lee — Asian Style Stylist</h3> <p class="team-card-bio">
